  ...
  return (
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, backgroundColor: "#1e293b", color: "#f1f5f9", padding: "16px 24px", zIndex: 9999, display: "flex", flexDirection: "column", gap: "12px", boxShadow: "0 -2px 10px rgba(0,0,0,0.3)" }}>
      <p style={{ margin: 0, fontSize: "14px", lineHeight: "1.6" }}>
        <strong>Privacy Notice:</strong> FixMyCampus collects your name, email, and maintenance report data to help manage campus issues. Your data is stored securely and used only for this purpose. We do not share your personal information with third parties.
      </p>
